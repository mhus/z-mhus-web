...
public class DefaultHeadRenderer extends MLog implements ResourceRenderer {
	...
	public void doRender(HttpServletRequest req, HttpServletResponse res, String retType, CaoNode navResource, CaoNode resResource) throws IOException {
		doRenderHead(req, res, retType, navResource, resResource);
	}

	public static void doRenderHead(HttpServletRequest req, HttpServletResponse res, String retType, CaoNode navResource, CaoNode resResource) throws IOException {
